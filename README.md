...
M'apassiona el món de la tecnologia, especialment la **ciberseguretat**, amb un fort interès en el **hacking ètic** i l’**OSINT (Open Source Intelligence)**. Gaudeixo analitzant, investigant i millorant constantment les meves habilitats tècniques.

Em considero una persona responsable, curiosa i amb moltes ganes de créixer dins del sector IT.
...
- Manteniment bàsic de sistemes  
- Experiència en entorn professional informàtic  
